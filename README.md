...
```bash
git clone https://github.com/scovl/GopherLab.git
cd GopherLab
```
...
└── docker-compose.yml        # 5 serviços: runner, terminal, gopherlab, dev, runner-test
```
...
A maioria das plataformas de aprendizado de Go oferece leitura passiva e quizzes. O GopherLab se diferencia em três pontos:
