      ...
      vesa: {
        ...
        experimentacao: {
          ...
          dicas: [
            ...
            'staticcheck detecta cÃ³digo morto e anti-patterns',
          ],
        },
        socializacao: {
          discussao: 'Qual o conjunto mÃ­nimo de ferramentas que todo projeto Go deveria ter no CI?',
          pontos: [
            'go vet + go test -race: mÃ­nimo absoluto',
            'golangci-lint: padrÃ£o de mercado para CI',
            'govulncheck: seguranÃ§a de dependÃªncias',
          ],
          diasDesafio: 'Dias 91â€“96',
          sugestaoBlog: 'Tooling Go: do gofmt ao golangci-lint â€” qualidade de cÃ³digo automatizada',
    ...
    },
    {
      ...
      vesa: {
        ...
        experimentacao: {
          ...
          dicas: [
            'import _ "net/http/pprof" â€” automÃ¡tico no default mux',
            'go tool pprof -http=:8081 profile.pb.gz â€” web UI',
        ...
        aplicacao: {
          projeto: 'Profile e otimize uma aplicaÃ§Ã£o: CPU profile, heap profile, corrija alocaÃ§Ãµes e meÃ§a melhoria.',
          requisitos: [
            'pprof ativo com endpoints /debug/pprof',
            'CPU e heap profiles coletados',
            'Bottleneck identificado e otimizado',
          ],
          criterios: ['Profiling executado', 'Bottleneck encontrado', 'Melhoria mensurÃ¡vel (benchmark)'],
        },
      },
    },
  ],
